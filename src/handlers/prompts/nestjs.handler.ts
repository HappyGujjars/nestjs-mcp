...
export class NestjsPromptHandler implements IPromptHandler {
  readonly definition: PromptDefinition = {
    name: 'rules',
    description:
      'Activates Senior Full-Stack Architect mode: enforces strict NestJS + Sequelize coding standards, Zod validation, design patterns, and clean architecture.',
  };

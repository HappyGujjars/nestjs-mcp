...
export class ReviewCodePromptHandler implements IPromptHandler {
  readonly definition: PromptDefinition = {
    name: 'review-code',
    description:
      'Reviews provided code against the strict NestJS Pro Architect standards and returns a prioritized list of violations with fixes.',
    arguments: [
      {
        name: 'code',

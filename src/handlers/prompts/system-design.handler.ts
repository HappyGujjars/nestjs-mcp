...
export class SystemDesignPromptHandler implements IPromptHandler {
  readonly definition: PromptDefinition = {
    name: 'system-design',
    description:
      'Evaluates requirements and provides an authoritative architectural recommendation based on the NestJS Pro Architecture Matrix.',
    arguments: [
      {
        name: 'requirements',

...
export class ModulePromptHandler implements IPromptHandler {
  readonly definition: PromptDefinition = {
    name: 'module',
    description:
      'Generates a complete NestJS feature module scaffold: controller, service, repository, queries, model, interface, and Zod DTOs.',
    arguments: [
      {
        name: 'featureName',

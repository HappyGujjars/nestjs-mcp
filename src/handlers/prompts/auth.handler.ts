...
export class AuthPromptHandler implements IPromptHandler {
  readonly definition: PromptDefinition = {
    name: 'auth-module',
    description:
      'Implements a production-grade Authorization Module with Access/Refresh tokens, Redis state management, and OIDC support (Google, Apple, Facebook, GitHub).',
  };
